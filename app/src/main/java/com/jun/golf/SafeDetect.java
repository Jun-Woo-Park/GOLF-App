...
import static com.jun.golf.MainActivity.CityDetectHeight;
import static com.jun.golf.MainActivity.DetectWidth;
import static com.jun.golf.MainActivity.LaneDetectHeight;
import static com.jun.golf.MainActivity.alarm_mode;
import static com.jun.golf.MainActivity.auto_adjust_detect_area;
import static com.jun.golf.MainActivity.device_temperature;
import static com.jun.golf.MainActivity.front_car_start_voiceId;
import static com.jun.golf.MainActivity.mactivity;
import static com.jun.golf.MainActivity.person_detect_focus;
import static com.jun.golf.MainActivity.recent_fps;
import static com.jun.golf.MainActivity.reset_notice_start_time;
import static com.jun.golf.MainActivity.rest_2hour_voiceId;
import static com.jun.golf.MainActivity.road_type;
import static com.jun.golf.MainActivity.toast_msg;
import static com.jun.golf.MainActivity.toohot_alarm_time;
import static com.jun.golf.MainActivity.toohot_voiceId;
import static com.jun.golf.MainActivity.ultra_fast_mode;
...
public class SafeDetect {
    ...
    protected void draw_safe_zone(Canvas canvas,safe_region_param sp) {
        ...
        linePaint.setColor(Color.argb(180,70,65,217));
...
*/
    ...
    public void safeDetect(Canvas canvas, Box[] results, MainActivity main,safe_region_param sp,Distance distance,int lane_offset,int frame_count) {
        long time_now = SystemClock.elapsedRealtime(); //Time Check
                    ...
                    //if(Math.abs(distance1 - distance2) > 0.001f) {
                        ...
                        if ((distance2 / near_object_speed) < judge_time && distance2 > 1 &&
                            ...
                            if (alarm_mode != 0 && time_now - last_alarm_time > 2000) {
                                ...
                                MainActivity.detect_msg = "전방 조심，충돌 가능";
            ...
            if ((last_detect_alert_time[i] != 0) &&
                ...
                switch (i) {
                    case DETECT_ALARM_LEFT:
                        MainActivity.detect_msg = "왼쪽 물체가 주행 구역으로 들어가다.";
                        alarm_box(canvas, 0, 1, 0);
                        break;
                    case DETECT_ALARM_RIGHT:
                        MainActivity.detect_msg = "우측 물체가 주행 구역으로 들어가다.";
                        alarm_box(canvas, 0, 0, 1);
                        break;
                    case DETECT_ALARM_FRONT:
                        MainActivity.detect_msg = "전방 물체가 주행 구역으로 들어가다.";
                        alarm_box(canvas, 1, 0, 0);
                        break;
                }
